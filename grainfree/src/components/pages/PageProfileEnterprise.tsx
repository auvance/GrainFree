...
export default function PageProfileEnterprise() {
  ...
  return (
    <main className="min-h-screen bg-black text-white flex">
      {/* Sidebar */}
      <aside className="w-80 border-r border-white/10 bg-black p-6 flex flex-col">
        <div className="mb-8">
          <h1 className="text-2xl font-semibold text-[#00B84A]">Settings</h1>
          ...
          {menu.map((item) => {
            ...
            return (
              <button
                ...
                className={[
                  "px-4 py-3 rounded-xl text-left transition-all duration-200 ease-out",
                  "active:scale-[0.99]",
                  active
      ...
      {/* Content */}
      <section className="flex-1 p-10 bg-[#0B0F0E]">
        <div
          key={animKey}
          className={[
