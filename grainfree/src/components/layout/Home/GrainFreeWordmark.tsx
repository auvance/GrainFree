    ...
    <section className="relative overflow-hidden rounded-xl bg-[#FAFAF5]">
      ...
      <div className="relative mx-auto w-full max-w-[1500px] px-4 sm:px-8 lg:px-10">
        ...
        <div className="relative h-[420px] sm:h-[520px] lg:h-[680px]">
          ...
          >
            <div className="relative h-[150px] w-[150px] sm:h-[190px] sm:w-[190px] lg:h-[270px] lg:w-[220px] overflow-hidden bg-black/5 ">
          ...
          >
            <div className="relative h-[240px] w-[140px] sm:h-[330px] sm:w-[170px] lg:h-[480px] lg:w-[300px] overflow-hidden bg-black/5">
              <div className="absolute inset-0 bg-black/10" />
              <Media tile={tile2} />
              <div className="pointer-events-none absolute inset-0 ring-1 ring-black/5" />
            </div>
          ...
          <div className="absolute right-4 sm:right-8 lg:right-14 top-12 sm:top-16 lg:top-16 z-10 flex items-end flex-col gap-7">
            <HoverTile strength={8} className="relative">
              <div className="relative h-[90px] w-[170px] sm:h-[120px] sm:w-[240px] lg:h-[180px] lg:w-[400px] overflow-hidden bg-black/5">
                <div className="absolute inset-0 bg-black/10" />
                <Media tile={tile3} />
                <div className="pointer-events-none absolute inset-0 ring-1 ring-black/5" />
              </div>
            ...
            <HoverTile strength={8} className="relative">
              <div className="relative h-[105px] w-[170px] sm:h-[135px] sm:w-[240px] lg:h-[155px] lg:w-[340px] overflow-hidden bg-black/5">
                <div className="absolute inset-0 bg-black/10" />
                <Media tile={tile4} />
                <div className="pointer-events-none absolute inset-0 ring-1 ring-black/5" />
              </div>
          ...
          {/* ---------------------------
              STICKER — independent hover motion
          --------------------------- */}
          <HoverTile
            strength={6}
